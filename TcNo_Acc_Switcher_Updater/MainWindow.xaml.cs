...
#pragma warning restore CA2211 // Non-constant fields should not be visible
        ...
        {
            Process.Start(new ProcessStartInfo(@"TcNo_Acc_Switcher.exe") { UseShellExecute = true });
        ...
        public static void RestartAsAdmin(string args)
        {
	        var proc = new ProcessStartInfo
	        {
		        ...
		        FileName = Assembly.GetEntryAssembly()?.Location.Replace(".dll", ".exe") ?? "TcNo_Acc_Switcher.exe",
        ...
        private static string GetVersionFromGlobals()
        {
            ...
            var dllPath = Path.Join(Directory.GetCurrentDirectory(), "TcNo_Acc_Switcher_Globals.dll");
        ...
        {
            const string newFolder = "TcNo_Acc_Switcher";
